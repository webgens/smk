	<style type="text/css">
		.gnb .gnb-list.none { overflow: auto; height: 46px; border-bottom: none; }
		.sch_area { position:absolute; bottom:0; width:100%; border-top:1px solid #e1e1e1; }
		.wrap-sort>div { border-bottom: 0; }
	</style>
</head>
...
<body>
    ...
    <!-- Navigation -->
    <nav id="gnb" class="gnb" style="height:80px;">
        <div class="wrap-gnb">
            <div class="area-gnb">
                <ul class="gnb-list">
        ...
        <section class="wrap-sort sch_area">
            <div class="all" id="Category" onclick="SubCategoryLayerOpen('<%=SCode1%>', '<%=Scode2%>', '<%=SCode3%>');">
                <button type="button" id="category3name"><% If Top_CategoryName = "" Then %>전체<% Else %><%=Top_CategoryName%><% End If %></button>
            </div>
