...
<%
'/****************************************************************************************'
'Product_Latest_Delete.asp - 최근 본 상품 삭제
'Date		: 2019.01.06
'Update	: 
'/****************************************************************************************'
...
IF ProductCode = "ALL" THEN
		...
		WITH oCmd
				...
				.CommandText		 = "USP_Front_EShop_Product_Latest_Delete_For_ALL_By_MemberNum"
...
ELSEIF ProductCode <> "" THEN
		...
		WITH oCmd
				.ActiveConnection	 = oConn
				.CommandType		 = adCmdStoredProc
				.CommandText		 = "USP_Front_EShop_Product_Latest_Delete"
