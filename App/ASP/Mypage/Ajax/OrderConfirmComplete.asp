...
<%
'/****************************************************************************************'
'OrderConfirmComplete.asp - 주문 구매확정 완료 페이지
'Date		: 2019.01.03
'Update	: 
'/****************************************************************************************'
...
ELSE
		...
		Response.Write "FAIL|||||주문내역이 없습니다."
		Response.End
END IF
oRs.Close
...
%>					
        ...
        <div class="area-pop">
            <div class="alert">
                <div class="tit-pop">
                    <p class="tit">구매확정 완료</p>
                </div>

                <div class="container-pop">
                    <div class="contents">
                        <div class="ly-cont">
							<%IF OrderState <> "7" THEN%>
                            <p class="t-level4">
								죄송합니다. 구매 확정이 되지 않았습니다.<br />
								구매 확정을 다시 해주십시오.
                            </p>
							<%ELSEIF U_MFLAG = "Y" AND CDbl(ProductPoint) > 0 THEN%>
                            <p class="t-level4">
								구매 확정이 완료되어<br> 
								<em style="color:#e60917; font-size:14px;"><%=FormatNumber(ProductPoint, 0)%><span>원</span></em>이 포인트로 적립되었습니다.<br />
								고객님의 총 보유 포인트가 <em style="color:#e60917; font-size:14px;"><%=FormatNumber(TotalPoint, 0)%>원</em>이 되었습니다. <br>
								(즉시 사용가능)
                            </p>
							<%ELSE%>
                            <p class="t-level4">구매 확정 되었습니다.</p>
							<%END IF%>
                        </div>
                    </div>
                    <div class="btns">
