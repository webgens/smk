...
ListType		 = sqlFilter(Request("ListType"))
SDate			 = sqlFilter(Request("SDate"))
EDate			 = sqlFilter(Request("EDate"))


IF ListType = "" THEN ListType	= "Order"
...
<!-- #include virtual="/INC/Header.asp" -->
	<style type="text/css">
		...
		.delivery-price { margin-bottom: 7px; line-height: 18px; }
...
<!-- #include virtual="/INC/TopSub.asp" -->
                ...
                <div class="shopping-list">
                    <section>
                        <div id="MypageSubMenu" class="ly-title accordion">
                            <div class="selector">
	                            <button type="button" class="btn-list clickEvt" data-target="MypageSubMenu">주문/배송조회/영수증 발급</button>
							</div>
                            ...
                            <div id="tabs">
                                <div class="tab-mypage">
                                    <ul class="tab-selector">
                                        <li class="part-2"><a href="javascript:chgTab('Order');">주문/배송조회</a></li>
                                        <!-- 탭메뉴 갯수에 따른 클래스명 지정 : part-탭메뉴 갯수 예) 탭메뉴가 3개일 때, part-3 -->
                                        <li class="part-2"><a href="javascript:chgTab('Receipt');">영수증발급</a></li>
                                    </ul>
                                    <!-- 주문/배송조회 -->
									<form name="form" id="form">
										<input type="hidden" name="ListType"	id="ListType"		value="<%=ListType%>"	/>
										<input type="hidden" name="Page"		id="Page"			value="1"	/>
										<input type="hidden" name="SOrderState" id="SOrderState"	value=""	/>
	...
	<!-- A/S 신청하기 POP -->
	<section class="wrap-pop" id="afterServiceView"></section>
	<!-- //A/S 신청하기 POP -->
