        ...
        <div class="area-pop">
            <div class="full">
                <div class="tit-pop">
                    ...
                    <button type="button" onclick="APP_PopupHistoryBack();" class="btn-hide-pop">닫기</button>
                </div>
                ...
                <div class="container-pop mypage-ty2">
                    ...
                    <div class="contents">
                        <div class="wrap-mtom">
                            <div class="reason">
                                <span class="select">
									<select name="CombineID" id="CombineID" title="계정선택">
...
%>
                    ...
                    <div class="btns" style="position: fixed;bottom: 0;width: 100%;height:60px;">
                        <button type="button" onclick="chk_MyIdCombine();" class="button ty-red">확인</button>
                        <button type="button" onclick="APP_PopupHistoryBack();" class="button ty-black">취소</button>
                    </div>
                </div>
            </div>
        </div>
