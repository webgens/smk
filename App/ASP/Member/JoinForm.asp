...
'# Response.Write "ParentGender		 = " & ParentGender & "<br>"
'# Response.Write "ParentMobile		 = " & ParentMobile & "<br>"
...
IF AgreeChk1 <> "Y" OR AgreeChk2 <> "Y" THEN
		Response.Redirect "/ASP/Error/ErrorPopupNone.asp?Title=SHOEMARKER&Msg=이용약관 동의를 하셔야 합니다.&Script=location.href='/ASP/Member/Join.asp';"
		Response.End
END IF

IF JoinType = "U" AND SDupInfo = "" THEN
		Response.Redirect "/ASP/Error/ErrorPopupNone.asp?Title=SHOEMARKER&Msg=본인인증 정보가 없습니다.&Script=location.href='/ASP/Member/Join.asp';"
		Response.End
END IF
                ...
                <div class="formfield">
                    ...
                    <fieldset class="">
                        ...
                        <div class="fieldset ty-row">
                            ...
                            <div class="fieldset-row">
                                <div class="radiogroup" id="SexArea">
<%
...
%>
                    ...
                    <fieldset class="">
                        ...
                        <div class="fieldset">
                            ...
                            <div class="fieldset-row">
                                <span class="input is-expand">
                                    <input type="email"name="Email" id="Email"  placeholder="이메일주소를 입력해 주세요.">
                                </span>
                            </div>
                        </div>
                        <!-- *** 수정 *** 190110 : 주소 입력창 추가 -->
