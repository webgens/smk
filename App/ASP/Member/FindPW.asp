    ...
    <main id="container" class="container">
        <div class="content">
            ...
            <nav class="login-method">
                <ul>
                    <li class="part-2"><a href="FindID.asp">아이디 찾기</a></li>
                    <li class="part-2"><a href="#" class="current">비밀번호 찾기</a></li>
                </ul>
            </nav>

            <div class="find-form">
                <!-- 필요시 form 엘리먼트로 교체해서 사용 (클래스명은 유지해주세요)-->
                    ...
                    <div id="tabs-col1" class="tab-panel">
                        ...
                        <fieldset id="FW_N_Form">
                            ...
                            <div id="FW_N_Email" style="display:none" class="fieldset">
                                ...
                                <div class="fieldset-row">
                                    <span class="input is-expand">
                                        <input type="text" name="Email" id="Email1" maxlength="50" placeholder="가입 시 등록하신 이메일주소를 입력해주세요.">
                                    </span>
                                </div>
                            </div>
                        </fieldset>
