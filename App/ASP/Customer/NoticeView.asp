        ...
        <div class="area-pop">
            <div class="full">
                ...
                <div class="container-pop">
                        ...
                        <div class="pop-customer">
                            ...
                            <div class="cnt">
								...
								<%IF FileName <> "" THEN%>
									...
									<%ELSE%>
									첨부파일 : <a href="javascript:void(0)" onclick="openExternal('https://m.shoemarker.co.kr/Common/Down.asp?file=<%=MID(FileName, INSTRREV(FileName,"/")+1)%>&dtype=Notice')"><%=MID(FileName, INSTRREV(FileName,"/")+1)%></a>
									<%END IF%>
								<%END IF%>
                            </div>
                        </div>
                    ...
                    <div class="btns">
                        <button type="button" onclick="APP_PopupHistoryBack()" class="button ty-red">닫 기</button>
                    </div>
                </div>
            </div>
        </div>
