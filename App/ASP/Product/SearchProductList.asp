...
SearchWord		 = sqlFilter(Request("SearchWord"))
...
<!-- #include virtual="/INC/Top_ProductSearch.asp" -->
    ...
    <main id="container" class="container">
        <div class="content">
            ...
            <section class="wrap-item-list">
                <div class="item-bg">
                    <img src="/images/img/img_search_result.jpg" alt="sale">
                    <p>상품검색</p>
                </div>

                <div class="cont">
                    <div class="tit"><%=SearchWord%> (<span id="SearchCount">0</span>)</div>
                </div>
	...
	<script type="text/javascript">
		function get_ProductList(page) {
			...
			$.ajax({
				url: '/ASP/Product/Ajax/ProductSearchList.asp',
		...
		function OrderBySelect(sort) {
			...
			document.form.action = "/ASP/Product/SearchProductList.asp";
...
If SearchWord <> "" Then
	wQuery = wQuery & " AND (A.ProductName Like '%" & SearchWord & "%' OR A.MainKeyWord Like '%" & SearchWord & "%' OR A.KeyWord Like '%" & SearchWord & "%' OR A.ProductCD Like '%" & SearchWord & "%' ) "
End If
